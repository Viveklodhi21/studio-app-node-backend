...
export const addshopUserData = async (req: any, res: Response) => {
  const {
    shopId,
    shopUserName,
    shopUserEmail,
  ...
  try {
    ...
    const data:any = new ShopUser(shopUserData);
...
export const getshopUsers = async (req: any, res: Response) => {
  try {
...
export const editshopUser = async (req: any, res: Response) => {
  const {
    shopUserName,
    shopUserEmail,
    shopUserAddress,
...
export const deleteshopUser = async (req: any, res: Response) => {
  try {
